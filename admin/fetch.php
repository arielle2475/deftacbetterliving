...
<?php
include('../superadmin/gallery/database_connection.php');
...
if($number_of_rows > 0)
{
 ...
 foreach($result as $row)
 {
  ...
  <tr >
   ...
   <td class="text-center border rounded-0"><img src="../superadmin/gallery/files/'.$row["image_name"].'" class="img-thumbnail" width="100" height="100" /></td>
