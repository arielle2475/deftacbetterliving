	...
	<div class="container">
      <div class="">
		...
		<table id="employee_grid" class="table table-condensed table-hover table-striped" width="60%" cellspacing="0" data-toggle="bootgrid">
          ...
          <th data-column-id="adminavatar" data-formatter="image" data-sortable="false">Avatar</th>
					<th data-column-id="adminname">Name</th>
					<th data-column-id="adminemail">Email</th>
					<th data-column-id="isactive">Status</th>
...
$( document ).ready(function() {
	var grid = $("#employee_grid").bootgrid({
      ...
      "image": function(column, row) {
             return "<img class='table-img' style='height:50px;' src='../" + row.adminavatar + "' />";
        },
...
console.log(g_id);
		...
		$('#edit_model').modal('show');
					if($(this).data("row-id") >0) {
                                ...
                                $('#edit_salary').val(ele.siblings(':nth-of-type(4)').html());
