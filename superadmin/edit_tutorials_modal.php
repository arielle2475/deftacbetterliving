...
<!-- Modal  -->
<div id="edit_tutorials<?php echo $row['id']; ?>" style="margin:0%; height: 100vh;" data-backdrop="false"class="modal fade" role="dialog" tabindex="-1" style="opacity: 1;font-family: Montserrat, sans-serif;">
...
<!-- Modal Content -->
   ...
   <div class="modal-content">
	   ...
	   <?php
					$edit=mysqli_query($conn,"select * from tutorials where id='".$row['id']."'");
					$erow=mysqli_fetch_array($edit);
				?>
				<div class="container-fluid">
				<form method="POST" action="edit_tutorials.php?id=<?php echo $erow['id']; ?>">
						<div class="col-lg-2">
