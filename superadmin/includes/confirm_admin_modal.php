<div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-header" style="color: rgb(255,255,255);background-color: rgba(0,0,0);">
        <h5 class="modal-title" style="font-weight:bold;" id="confirmTitle"></h5>
            ...
            <div class="modal-footer" style="background-color: rgba(0,0,0);">
                <div class="row">
                        <form action="" method="POST" id='confirmForm'>
                            <input type="submit" class="btn" id="confirmButton" value='' style="font-weight:bold; margin-right:10px; height:40px; ">
                        </form> 
