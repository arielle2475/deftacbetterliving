   ...
   <div class="modal-content">
     ...
     <form action=""  method="post" enctype="multipart/form-data">
       ...
       <input class="btn" type="file" name="avatar" value="../Signin/images/<?= $_SESSION['avatar']?>"  /> 
        <td colspan="2"><input class="btn btn-warning" style="color:white;" type="submit" name="update" onsubmit="setTimeout(function () { window.location.reload(); }, 10)"value="Update Avatar"/></td></form>
