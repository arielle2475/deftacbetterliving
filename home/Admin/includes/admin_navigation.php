<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./index.php">Admin | Deftac Betterliving</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
               ...
               <li><a href="../index.php">Visit Website</a></li>
                ...
                <li class="dropdown">
                    ...
                    <i class="fa fa-user"><span class="user"><?= $_SESSION['username'] ?></span></h3>
<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="../signin/login.php"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#admin"><i class="fa fa-fw fa-users"></i> Admins<i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="admin" class="collapse">
                            <li>
                                <a href="./adminsubmit.php"> View Admins</a>
                            </li>
                            <li>
                                <a href="./editadmin.php?source=add_user"> Add Admins</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="editadmin.php"><i class="fa fa-fw fa-dashboard"></i> Profile</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
